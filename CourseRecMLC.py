...
# Second Cycle: Content-Based Filtering
...
if student_row.empty:
    ...
    # Define the feature columns for the dataset (these are the full set of columns in your dataset)
    feature_columns = ['MATEMATIK', 'MATEMATIK TAMBAHAN', 'FIZIK', 'BIOLOGI', 'KIMIA', 
                       'BAHASA MALAYSIA', 'BAHASA INGGERIS', 'PENDIDIKAN SENI VISUAL', 
                       'EKONOMI', 'PERNIAGAAN', 'PRINSIP PERAKAUNAN', 'TASAWWUR ISLAM', 
                       'PENDIDIKAN ISLAM', 'SEJARAH', 'MORAL', 'SAINS', 'Learning Style']

    # Initialize missing columns with default values (e.g., 0 for grades and 0 for Learning Style)
    ...
    # Now calculate the cosine similarity between the user preferences and the dataset
